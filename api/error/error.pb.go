...
var file_error_error_proto_rawDesc = []byte{
	...
	0x32, 0x70, 0x67, 0x63, 0x6e, 0x2f, 0x67, 0x61, 0x6d, 0x65, 0x69, 0x6d, 0x2f, 0x61, 0x70, 0x69,
	0x2f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x3b, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_error_error_proto_goTypes = []interface{}{
	(*Status)(nil), // 0: error.Status
	nil,            // 1: error.Status.MetadataEntry
}
var file_error_error_proto_depIdxs = []int32{
	1, // 0: error.Status.metadata:type_name -> error.Status.MetadataEntry
