...
const (
	Logic_OnAuth_FullMethodName    = "/logic.Logic/OnAuth"
	Logic_OnConnect_FullMethodName = "/logic.Logic/OnConnect"
	Logic_OnMessage_FullMethodName = "/logic.Logic/OnMessage"
	Logic_OnClose_FullMethodName   = "/logic.Logic/OnClose"
)
...
type LogicClient interface {
	...
	OnMessage(ctx context.Context, opts ...grpc.CallOption) (Logic_OnMessageClient, error)
...
func (c *logicClient) OnAuth(ctx context.Context, in *AuthReq, opts ...grpc.CallOption) (*AuthReply, error) {
	out := new(AuthReply)
	err := c.cc.Invoke(ctx, Logic_OnAuth_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logicClient) OnConnect(ctx context.Context, in *ConnectReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, Logic_OnConnect_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logicClient) OnMessage(ctx context.Context, opts ...grpc.CallOption) (Logic_OnMessageClient, error) {
	stream, err := c.cc.NewStream(ctx, &Logic_ServiceDesc.Streams[0], Logic_OnMessage_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &logicOnMessageClient{stream}
	return x, nil
}

type Logic_OnMessageClient interface {
	Send(*MessageReq) error
	CloseAndRecv() (*MessageReply, error)
	grpc.ClientStream
}

type logicOnMessageClient struct {
	grpc.ClientStream
}

func (x *logicOnMessageClient) Send(m *MessageReq) error {
	return x.ClientStream.SendMsg(m)
}

func (x *logicOnMessageClient) CloseAndRecv() (*MessageReply, error) {
...
func (c *logicClient) OnClose(ctx context.Context, in *CloseReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Logic_OnClose_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LogicServer interface {
	...
	OnMessage(Logic_OnMessageServer) error
...
func (UnimplementedLogicServer) OnMessage(Logic_OnMessageServer) error {
...
func _Logic_OnAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Logic_OnAuth_FullMethodName,
	}
...
func _Logic_OnConnect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Logic_OnConnect_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Logic_OnMessage_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(LogicServer).OnMessage(&logicOnMessageServer{stream})
}

type Logic_OnMessageServer interface {
	SendAndClose(*MessageReply) error
	Recv() (*MessageReq, error)
	grpc.ServerStream
}

type logicOnMessageServer struct {
	grpc.ServerStream
}

func (x *logicOnMessageServer) SendAndClose(m *MessageReply) error {
	return x.ServerStream.SendMsg(m)
}

func (x *logicOnMessageServer) Recv() (*MessageReq, error) {
	m := new(MessageReq)
...
func _Logic_OnClose_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Logic_OnClose_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
